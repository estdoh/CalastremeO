...
class ControllerExtensionDashboardSale extends Controller {
	...
	public function dashboard() {
		...
		if ($sale_total > 1000000000000) {
			$data['total'] = round($sale_total / 1000000000000, 3) . 'T';
		} elseif ($sale_total > 1000000000) {
			$data['total'] = round($sale_total / 1000000000, 3) . 'B';
		} elseif ($sale_total > 1000000) {
			$data['total'] = round($sale_total / 1000000, 3) . 'M';
		} elseif ($sale_total > 1000) {
			$data['total'] = round($sale_total / 1000, 3) . 'K';
		} else {
